...
require(['nls', 'config', 'EvenRegister', 'artificial','logon', 'newsroom', 'active', 'forget_password', 'filter', 'setting', 'infomation', 'question', 'policy',
    ...
    'surveyConfirm','surveyQuestionnaires','uploadInfo','ca','add_registration','registration_confirm','registration_show','registration_record','registration_term','registration_rule','team_registration','registration_manager','echarts','canteen','canteenrule','canteensuper','line','lineShow','profile','comments','hotline','uploadInvoice','panle','world','myCornerHome', 'assistantHome','ca_help','order','eInvoice', 'eInvoiceRule', 'eInvoiceIntroduciton', 'eInvoicePdf','mobiscroll','mustache','text!club_firstBanner','introduction','my_activities','shop','rePwBId','voice','shake','integral','integral_rules','jobPost', 'blank', 'card', 'helper'], function() {//Redaholic
    // 全局变量开启
    window.q = {};
